  ...
  return (
    <>
      <div className="w-full min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-2/5 flex flex-col items-center justify-center bg-[#F4FCF9] px-6 py-12 lg:px-16">
          <div className="mb-10">
            <Image
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <h2 className="title">
              උපකාර කිරීමට බලපොරොත්තු වීම පිලිබදව බොහොමත් ස්තුතියි.
            </h2>
